            ...
            <div class="card-body">
                <form action="{{route('teacher.update' , $teacher->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="alamat" name="alamat" required>{{$teacher->alamat}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="no_telepon">No_Telepon</label>
                        <input type="text" class="form-control" id="no_telepon" name="no_telepon" value="{{$teacher->no_telepon}}" required>
                    </div>
                   <div class="form-group">
                        <label for="mapel">Mata Pelajaran</label>
                        <input type="text" class="form-control" id="mapel" name="mapel" value="{{$teacher->mapel}}" required>
                    </div>
